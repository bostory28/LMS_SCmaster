	...
	<table class="table table-bordered" style="font-family:fantasy; ">
		...
		<s:iterator value="list_test" status="stat">
			<tr style="text-align: center;">
				...
				<td>
					<input type="text" name="list_write" style="text-align: center;" class="form-control">
				</td>
				<td>
					<input type="text" name="list_interview" style="text-align: center;" class="form-control">
				</td>
				<td>
					<input type="text" name="list_speech" style="text-align: center;" class="form-control">
				</td>
			</tr>
		</s:iterator>
		<tr>
