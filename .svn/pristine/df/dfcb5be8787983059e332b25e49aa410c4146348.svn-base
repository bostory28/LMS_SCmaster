...
<body>
<form action="avapicUpdate.action" onsubmit="return nullCheckUpdate();" method="post" id="propicForm" enctype="multipart/form-data">
	<table>
		<tr>
			<td>
		...
		<tr>
			<td align="right">
				<input type="submit" class="btn btn-default" value="아바타변경">
			</td>
		</tr>
	</table>
</form>
