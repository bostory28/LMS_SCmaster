		...
		<div class="row">
			...
			<div>
				...
				<s:textfield size="20" id="today" name="today"
					...
					<tr>
					<td colspan="1">작성자</td><td colspan="1"><s:property value="trou.studentid"/></td>
					<td colspan="1">제목</td><td colspan="1"><s:property value="trou.title"/></td>
					</tr>
					<tr>
					<td colspan="4">상담내용</td>
					</tr>
					<tr>
					...
					<tr>
					<td colspan="4"><s:property value="tbrp.contents"/></td>
					</tr>
					<tr>
					
					<td colspan="4"><input type="submit" value="목록"></td>
					</tr>
