...
<script type="text/javascript">
	$(document).ready(function() {
		$('#flag').change(function() {
			var flag = $('#flag').val();
			location.href="insertSubjectForm.action?flag=" + flag + "&field=IT";
		});
...
<table class="table table-bordered" style="font-family:fantasy;">
		<tr>
			<td colspan="4" align="center"  class="success">
				<b style="text-align: center;  font-size: 25px; font-family:serif;">&lt;IT과목별시험등록&gt;</b>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" class="form-control" id="testname" name="teasubteavo.testname">
			</td>
		...
		<tr>
			<td colspan="4" align="right" >
				<input type="button" id="insertbtn" value="시험등록" style="height: 35px; width: 130px" class="btn btn-primary">
			</td>
		</tr>
	</table>
</form>
