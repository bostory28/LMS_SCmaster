...
<table class="table table-bordered" style="font-family:fantasy; ">
		<tr>
			<td colspan="7" class="success" align="center">
				<b style="text-align: center;  font-size: 25px; font-family:serif;">&lt;IT역량평가성적수정&gt;</b>
			</td>
		</tr>
		...
		<s:iterator value="list_test" status="stat">
			<tr>
				...
				<td>
					<input type="text" name="score" value="<s:property value="list_test[#stat.index].score"/>" style="text-align: center;" class="form-control">
				</td>
			</tr>
		</s:iterator>
		<tr>
			<td colspan="7" align="right">
				<input type="button" id="edittbtn" value="성적수정" style="height: 35px; width: 130px" class="btn btn-primary">
			</td>
		</tr>
	</table>
</form>
