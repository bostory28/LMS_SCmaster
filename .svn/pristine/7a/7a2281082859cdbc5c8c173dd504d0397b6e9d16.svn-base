...
public class Board {
	...
	private int    pfdreplycount;      //댓글의 수(동적)
	...
	public Board(int boardnum, String id, String title, String content,
			...
			int replycount, int pfdreplycount, String boardtype) {
		super();
		...
		this.pfdreplycount = pfdreplycount;
	...
	public int getPfdreplycount() {
		return pfdreplycount;
	}

	public void setPfdreplycount(int pfdreplycount) {
		this.pfdreplycount = pfdreplycount;
	}
	...
	public String toString() {
		return "Board [boardnum=" + boardnum + ", id=" + id + ", title="
				...
				+ ", pfdreplycount=" + pfdreplycount + ", boardtype="
				+ boardtype + "]";
	}
