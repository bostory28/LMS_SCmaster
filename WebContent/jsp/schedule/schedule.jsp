...
<head>
	...
	function getSubjectAndTestList(start, end, timezone, callback){
    	...
    	$.ajax({
			...
			type : 'post',
			dataType : 'json',
			data : { flag : 27 }, // 달력을 27기 28기 따로 만들기 때문에 flag 변수는 고정.
    ...
    <div class="row">
    	<article class="thumbnail col-lg-9 col-sm-8 col-lg-push-3 col-sm-push-4">
            ...
            <ol class="breadcrumb">
              ...
              <li>일정관리 <span class="glyphicon glyphicon-circle-arrow-right"></span></li>
               <li class="active"><a href="../schedule/goScheduleForm.action">27기</a></li>
            </ol>
        ...
        <aside class="col-lg-3 col-sm-4 col-lg-pull-9 col-sm-pull-8 ">
       		<div class="thumbnail">
	            ...
	            <s:if test="%{#session.userSign.type==0||#session.userSign.type==1}">
	            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#">- 27기</a><br>
	            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../schedule/goScheduleForm28.action">- 28기</a><br>
	            </s:if>
