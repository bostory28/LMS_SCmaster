...
public class memberDAO {
	...
	public void avapicUpdateT(String id,String avapic){//선생님의아바타사진업뎃
		...
		HashMap<String,Object> map = new HashMap<String,Object>();
		map.put("id", id); map.put("avapic", avapic);
		System.out.println("선생님의아바픽업뎃dao1");
		System.out.println(id+" "+avapic);
		sqlSession.update("member.avapicUpdateT",map);
		System.out.println("선생님아바픽업뎃완료dao2");
		sqlSession.commit();
		sqlSession.close();
	...
	public List<Subject> myStudyListJ(String id) throws Exception{
		/*System.out.println("dao1");*/
		sqlSession = sqlSessionFactory.openSession();
		/*System.out.println("dao2");*/
		subjectListJ= sqlSession.selectList("member.myStudyListJ",id);
		/*System.out.println("dao3");*/
		sqlSession.commit();
		sqlSession.close();
		/*System.out.println("dao4");*/
